...
public class MemberController {
	...
	public String f1(@RequestBody MemberRegister mr)
	{
		...
		try {
			...
			Integer loginid=temp.queryForObject("select loginid from login where username='"+mr.getUsername()+"' and password='"+mr.getPassword()+"'",Integer.class);	
			...
			Integer memid=temp.queryForObject("select memid from member where loginid="+loginid,Integer.class);	
